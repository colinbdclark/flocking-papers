...
Flocking attempts to smooth over some of these systemic distinction between types of changes---particularly the distinction between signal-level events and scheduled events---by adopting a single, unified representation of change. (the unit generator...)
