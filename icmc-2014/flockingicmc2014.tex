...
Few would doubt that the performance factors of today's computer music systems are the same as they were on early mainframe systems, and the power of the unit generator abstraction for unifying both signal and composition-level changes is worth revisiting.
